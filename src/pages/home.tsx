  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        {/* Hero Content */}
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto text-bg-off-white animate-fade-in-up">
          ...
          <Link
            to="/buy"
            className="inline-flex items-center gap-2 bg-primary-brown text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-[#5a3620] transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
      ...
      <section className="py-20 bg-bg-off-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            {/* Image */}
            <div className="relative h-100 md:h-125 rounded-2xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
              <img
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Shorts Card */}
            <div className="group relative h-100 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100">
